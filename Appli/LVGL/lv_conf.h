 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_font_cn_14) LV_FONT_DECLARE(lv_font_cn_16) LV_FONT_DECLARE(lv_font_cn_24) LV_FONT_DECLARE(lv_font_cn_28) LV_FONT_DECLARE(lv_font_cn_36)
