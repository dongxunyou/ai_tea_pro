...
if((${BUILD_CONTEXT} MATCHES .*ExtMemLoader.*) OR (NOT DEFINED BUILD_CONTEXT))
    ...
    ExternalProject_Add(01_free_rtos_lcd_ExtMemLoader
	...
	set(ST_BOOT_FLASH_EXTMEMLOADER_PROJECT_BUILD_TARGET ${CMAKE_SOURCE_DIR}/ExtMemLoader/build/01_free_rtos_lcd_ExtMemLoader${CMAKE_EXECUTABLE_SUFFIX_CXX} CACHE FILEPATH "Path to extmemloader project target")
endif()
#-----------------------Build Appli Project-----------------------#
if((${BUILD_CONTEXT} MATCHES .*Appli.*) OR (NOT DEFINED BUILD_CONTEXT))
    message("   Build context: " Appli)
    ExternalProject_Add(01_free_rtos_lcd_Appli
	...
	set(ST_BOOT_FLASH_APPLI_PROJECT_BUILD_TARGET ${CMAKE_SOURCE_DIR}/Appli/build/01_free_rtos_lcd_Appli${CMAKE_EXECUTABLE_SUFFIX_CXX} CACHE FILEPATH "Path to appli project target")
endif()
